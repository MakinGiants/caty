...
public class NotificationFactoryTests {
  ...
  public void buildMessageNotification() {
    Notification notification =
        NotificationFactory.INSTANCE.build("Maria: hello Daniel", "facebook.messenger");
  ...
  public void buildSystemNotification() {
    Notification notification =
        NotificationFactory.INSTANCE.build("Something happened with phone", "android.vending");
